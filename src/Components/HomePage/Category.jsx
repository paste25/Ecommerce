...
const Category = ({item, btn}) => {
  ...
  return (
    <div className=" lg:w-full lg:h-full sm:mx-5 relative sm:w-[450px] sm:my-5 lg:my-0 w-[250px] mt-4">
      <Link to={item.link} onClick={handleLinkClick}>
      <div className="">
      <img src={item.img} alt="" className="lg:w-full lg:h-2/4 h-1/4 rounded-md"/>
      </div>
