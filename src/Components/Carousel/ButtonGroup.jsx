const ButtonGroup = ({ next, previous, goToSlide, ...rest }) => {
  ...
  return (
    <div className="carousel-button-group flex items-end justify-end pr-9 mb-6 mt-2">
      ...
      <button onClick={() => next()} className={`border p-3 rounded-3xl bg-[#f6f6f6] hover:bg-[#c4c4c4]  ${currentSlide === 2 ? 'invisible' : ''}`}><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-chevron-compact-right" viewBox="0 0 16 16">
